        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Turu = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_emlakturleri", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    emlakturuId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Emlaklar_emlakturleri_emlakturuId",
                        column: x => x.emlakturuId,
                        principalTable: "emlakturleri",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Emlak_Emlaklar_emlakId",
                        column: x => x.emlakId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Emlak_emlakId",
                table: "Emlak",
                column: "emlakId");

            migrationBuilder.CreateIndex(
                name: "IX_Emlaklar_emlakturuId",
                table: "Emlaklar",
                column: "emlakturuId");
        }
